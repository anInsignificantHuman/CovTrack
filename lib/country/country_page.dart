...
class CountryPage extends StatefulWidget {
  ...
  CountryPage(this.countryName, this.point1, this.point2, this.point3, this.point4);

  @override
  _CountryPageState createState() => _CountryPageState(this.countryName, this.point1, this.point2, this.point3, this.point4);
}

class _CountryPageState extends State<CountryPage> {
  final String countryName; 
  final num point1, point2, point3, point4;
  _CountryPageState(this.countryName, this.point1, this.point2, this.point3, this.point4);
          ...
          Card(  
            ...
            child: Column(  
              children: [  
                ...
                TextSection(
                  intOf(this.point4.truncate().toString()), 
